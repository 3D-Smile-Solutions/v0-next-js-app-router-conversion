...
const BRAND = {
  ...
  bgLight: "#F8FAFA", // Added for background consistency
}
...
export default function RevOpsChecklist() {
  ...
  const [showChecklist, setShowChecklist] = useState(true) // Controls visibility of checklist vs other views
      ...
      >
        ...
        <div id="printable-area" className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-red-300 font-bold mb-6 text-lg">⚠️ This is the only time you get to download this</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
              <button
                onClick={handlePrint}
                className="text-white px-8 py-4 rounded-lg font-bold shadow-lg hover:scale-105 transition-transform flex items-center justify-center gap-2 text-lg"
                style={{ backgroundColor: BRAND.primary }}
              >
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8 md:p-12 mb-8 no-print">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-[#0A252F] mb-2">📅 Schedule Your Free Strategy Call</h3>
              <p className="text-slate-600">Let's review your results and build your action plan</p>
            </div>
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: BRAND.bgLight }}>
      {/* Mobile Logo + Slogan - shown on mobile and tablet */}
      {showChecklist && !showLeadForm && !showResults && (
              ...
              <div className="flex items-center gap-4 w-full md:w-auto">
                <div className="hidden sm:flex flex-col items-end">
                  ...
                  <span
                    ...
                    style={{ color: BRAND.primary, fontFamily: "'Geist', sans-serif" }}
                  >
      ...
      {showChecklist && !showLeadForm && !showResults && (
        <div className="mt-12 bg-white rounded-2xl shadow-xl border border-slate-200 p-8 md:p-12 no-print">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-[#0A252F] mb-2">📅 Ready to Get Started?</h3>
            <p className="text-slate-600">
