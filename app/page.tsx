...
export default function RevOpsChecklist() {
      ...
      >
        ...
        <div id="printable-area" className="max-w-6xl mx-auto">
          ...
          >
            ...
            {/* Warning Text */}
            <p className="text-red-400 font-bold mb-8 text-lg">
              ⚠️ This is the only time you get to download this
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <button
                onClick={handlePrint}
                className="text-white px-10 py-5 rounded-lg font-bold shadow-lg hover:scale-105 transition-transform flex items-center justify-center gap-3 text-lg"
                style={{ backgroundColor: BRAND.primary }}
              >
          ...
          {/* Cal.com Calendar Embed - RESULTS PAGE */}
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8 md:p-12 mt-8 no-print">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-[#0A252F] mb-2">
                📅 Schedule Your Free Strategy Call
              </h3>
              <p className="text-slate-600">
                Let's review your results and build your action plan
              </p>
            </div>
  ...
  // ============================================
  // MAIN CHECKLIST PAGE (your original structure)
  // ============================================
  return (
    <div
    ...
    >
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-8 text-center md:text-left">
          <h1 className="text-3xl md:text-4xl font-extrabold text-[#0A252F] mb-2">
            Revenue Operations Efficiency Scorecard
          </h1>
